...
def main(scenario, demand_data, case, forced_suppliers=None, fixed_port_demand_factor=1):
    ...
    uk_energy_storage_twh = 85.0 # TWh
    ammonia_lhv = 18.8 # MJ/kg ammonia lower heating value
    uk_energy_storage_tonnes = uk_energy_storage_twh*3.6e+9*1e-3/ammonia_lhv
    print('UK additional ammonia import: '+f'{uk_energy_storage_tonnes:.2e}'+' tonnes')

    demand_df.loc[demand_df['id'] == 'port1216', 'Fuel_consumption'] += uk_energy_storage_tonnes
